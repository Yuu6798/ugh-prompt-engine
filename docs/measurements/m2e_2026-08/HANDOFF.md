...
> **【2026-08-14 supersession（08-11 版を更新）】本書の進捗主張は起草時点（08-01）の
> 記録であり stale。** **M2e は r0–r7 全段階完了**: census 1280/1280 = `census.json`、
> 判読正本 = [`m2e_r7_breakdown_curve_record_2026-08-14.md`](m2e_r7_breakdown_curve_record_2026-08-14.md)
> （昇格宣言なし・M4 G2 非解錠）。運転裁定の経緯 =
> [`m2e_r7_adjudication_2026-08-10.md`](m2e_r7_adjudication_2026-08-10.md) §8。
> 下の「0 件」宣言と段階表の r4–r7「未実施」を現在の状態として消費しないこと。
> 手順・契約（§2 以降のコマンド形・E-系列の教訓）は引き続き有効。
...
> **M2e の帯セル実測は 0 件である。**（08-01 時点・上記 supersession 参照）
> 1280 セルのうち完了は **0**。
