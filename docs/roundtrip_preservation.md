...
- R2/Q1-3: tempo estimator calibration, including low/half-tempo attractors.
  **R2 closed (2026-06-18):** bpm is excluded from the R3 trusted reproduction
  ...
  screen is reproducible by anyone with Drive access; the only remaining R1 artifact
  is the screen-external `wafu_jungle_174`, whose bytes are not yet acquired) and confirmed `CV_SCALE=5.0`
