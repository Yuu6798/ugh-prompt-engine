...
- [Recast Phase 0 Melody Spike](docs/recast_phase0_melody_spike.md) — Recast Phase 0 gate spike: deterministic pyin note extraction degenerates (1–4 notes/take), same-song vs cross-song similarity distributions fully overlap → gate fails; PR4 hard anchor replaced with chords+structure, melody marked `not_observable`
