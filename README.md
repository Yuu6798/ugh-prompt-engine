...
- [Composition PoC Report](docs/composition_poc_report.md) — C4 end-to-end demo results: deterministic synth performer, two-take needle comparison, sensor findings
