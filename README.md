...
- [AI-Performer Score Roadmap](docs/ai_performer_score_roadmap.md) — Merge roadmap (3 PRs) toward an "AI-as-performer score": merges prior art (MIR/CLAP/DCI-MIG/controllability-eval/EPR) with accumulated knowledge (K-series grip / roundtrip fixity / genre bias). PR1 = `control_profile` schema (score knows its honored channels), PR2 = score-adherence test + CLAP learned sensor, PR3 = K3 orthogonality (DCI/MIG) + per-generator device profiles
