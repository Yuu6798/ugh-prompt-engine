...
（screen 対象 7 本すべてが drive_file_id 保有）**。`wafu_jungle_174`（8 本目）は 2026-06-22 に corpus から除外（バイト入手予定なし）、これで R1 Drive corpus は screen 対象 7/7 で完結。並行して Q1-5（spectral 計器拡張）を closeout：外部 audio-analyzer
