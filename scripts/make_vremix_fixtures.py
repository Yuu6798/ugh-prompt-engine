...
def _dup_key_error(key: Any) -> GenerationError:
    return GenerationError(f"registry に重複キー {key!r} がある (fail-closed)")
...
_NoDuplicateKeyLoader = make_no_dup_safe_loader(_dup_key_error, deep=True)
