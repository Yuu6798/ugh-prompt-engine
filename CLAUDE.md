...
| [`docs/recast_phase0_melody_spike.md`](docs/recast_phase0_melody_spike.md) | Recast Phase 0 メロディ類似度スパイク: 決定論 pyin ノート抽出が縮退し同曲/異曲分布が重複（ゲート不成立）→ PR4 hard anchor は chords+structure に差し替え、melody は `not_observable` |
