...
| [`docs/l0b_closed_loop_record.md`](docs/l0b_closed_loop_record.md) | L0b 閉ループ記録 (T1/T2): 契約 v1 可行域開示で L0S 同一課題が 1 周回成功 (T1)、T2 round4→5 の Pareto 改善で操舵証拠を実測。副産物 = ヒントトークン非加算・role 文照合リーク・drone 区間の進行無音化 (L0a v2 材料。和声応答帰属は §3.1 で撤回) |
