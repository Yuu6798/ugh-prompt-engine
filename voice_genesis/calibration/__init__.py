...
設計正本 `DESIGN_VG_METER_CAL_DEBT_v1.0.md`（VG-METER-CAL-DEBT-DESIGN-v1.0）の
Phase A（framework core）を実装したものであり、以下は本パッケージのいずれの
API からも一切生成・実行されない:
...
設計正本: `voice_genesis/calibration/DESIGN_VG_METER_CAL_DEBT_v1.0.md`
