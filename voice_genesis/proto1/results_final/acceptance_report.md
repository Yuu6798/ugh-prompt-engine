...
| VG-010 | Registry + lineage log | parent/seed/version 保存 | `tests/test_registry.py`（13 件 pass）+ `results_final/genome_registry.jsonl`（4 エントリ、`genome-registry/0.1`）。F1-5 実演: `lineage(d)` = `[a(639af0f19fdb,sample), c(8fe0c4db1378,mutate), d(5b090455b809,crossover)]`（`results_final/e2e_run.json.run_2.lineage_of_d`。**2026-08-14 R34 再生成註**: genome_id は PR #261 R24–R36 の検証強化サイクルで audit/reference_set_hash 等の被覆対象フィールドが変わったため旧値から更新。probe 波形 hash 自体（VG-002 evidence）は不変） | **PASS** |
