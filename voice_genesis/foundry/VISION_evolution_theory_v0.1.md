...
> **後継版あり**: 個体学習層（LearningTransition / Identity Drift Gate /
> Determinism Contract）を追加した
> [`VISION_evolution_theory_v0.2.md`](VISION_evolution_theory_v0.2.md)
> が 2026-08-19 に収載済み（v0.1 の前提はそのまま継承 — v0.2 §「v0.1 から
> 継承する前提」参照）。
>
